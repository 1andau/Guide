...
function WishlistItem({name,id, title, imageUrl, totalPriceFav, totalCountFav, onRemoveFav,  price}) {
...
<Button onClick={handleRemoveFavClick} className="button--circle" outline>
